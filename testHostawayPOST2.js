...
async function run() {
  ...
  const payloads = [
    ...
    { title: "Test", amount: 240, type: "charge", currency: "USD", paymentMethod: "cash", status: "paid", chargeDate: "2026-05-10" },
    { title: "Test", amount: 240, type: "charge", currency: "USD", paymentMethod: "cash", isManual: 1 },
  ];
  ...
  for (const payload of payloads) {
    ...
    console.log("POST to charges/id:", resResponse.status, resData);
  }
}
