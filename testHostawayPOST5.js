...
async function run() {
  ...
  const payloads = [
    { title: "Test", amount: 240, type: "charge", currency: "USD", paymentMethod: "cash", status: "paid", scheduledDate: "2026-05-10 23:30:07" },
    { title: "Test", amount: 240, type: "charge", currency: "USD", paymentMethod: "cash", isManual: 1, scheduledDate: "2026-05-10 23:30:07" },
    { title: "Test", amount: 240, type: "charge", currency: "USD", paymentMethod: "cash", scheduledDate: "2026-05-10 23:30:07" },
  ];
  ...
  for (const payload of payloads) {
    ...
    console.log("POST:", JSON.stringify(payload), resResponse.status, resData);
  }
}
