...
async function run() {
  ...
  const payloads = [
    { title: "Test", amount: 240, type: "charge", currency: "USD", paymentMethod: "cash", status: "paid", scheduledDate: "2026-05-10" },
    { title: "Test", amount: 240, type: "charge", currency: "USD", paymentMethod: "cash", status: "paid", scheduledDate: "2026-05-10 12:00:00" },
  ];
